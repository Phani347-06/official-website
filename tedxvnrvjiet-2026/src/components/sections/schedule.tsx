    ...
    <section id="schedule" ref={containerRef} className="relative py-32 bg-black overflow-hidden">
          ...
          <div className="flex flex-col items-end text-right">
             <div className="p-6 glass rounded-3xl border border-white/10 flex items-center space-x-8">
                <div className="flex flex-col items-end">
                   ...
                   <span className="text-3xl font-black text-white uppercase tracking-tighter italic">VNRVJIET KS Auditorium</span>
                </div>
      ...
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="relative space-y-8">
           {/* Center Line */}
           <div className="absolute left-[39px] md:left-1/2 top-0 bottom-0 w-[1px] bg-gradient-to-b from-ted-red/50 via-ted-red to-ted-red/50 hidden md:block" />
           ...
           {siteData.schedule.map((item, i) => (
             ...
             >
               {/* Timeline Node */}
               <div className="absolute left-[31px] md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-ted-red shadow-[0_0_20px_rgba(230,43,30,0.8)] z-10 hidden md:block" />

               {/* Content Card */}
               <div className={`w-full md:w-[45%] group ${i % 2 === 0 ? "md:pr-12" : "md:pl-12"}`}>
