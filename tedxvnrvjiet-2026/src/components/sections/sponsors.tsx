...
import { Users, Handshake, Twitter, Linkedin } from "lucide-react";
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        {siteData.team.map((member, i) => (
          <motion.div
            ...
            className="group relative h-[450px] rounded-[3rem] overflow-hidden bg-white/5 border border-white/10 shadow-2xl transition-all hover:border-ted-red/40"
          >
            ...
            <div className="absolute bottom-0 left-0 w-full p-10 z-10">
               <div className="mb-4 flex space-x-4 opacity-0 group-hover:opacity-100 transition-opacity translate-y-4 group-hover:translate-y-0 duration-500">
                  <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-ted-red transition-colors backdrop-blur-md">
                    <Twitter size={18} />
                  </a>
                  <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-ted-red transition-colors backdrop-blur-md">
                    <Linkedin size={18} />
