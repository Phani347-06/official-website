...
export const Speakers = () => {
  ...
  return (
    <section id="speakers" ref={containerRef} className="relative py-24 bg-black overflow-hidden">
      ...
      <div className="relative w-full overflow-x-auto no-scrollbar py-12 px-6 lg:px-[10%]">
        <motion.div
          drag="x"
          dragConstraints={{ left: -1000, right: 0 }}
          className="flex space-x-8 cursor-grab active:cursor-grabbing w-max"
        >
          {siteData.speakers.map((speaker, i) => (
            <motion.div
              ...
              className="relative group w-[300px] md:w-[450px] aspect-[3/4] rounded-3xl overflow-hidden bg-white/5 border border-white/10"
            >
              {/* Image */}
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 z-10 flex flex-col items-start">
                ...
                <h3 className="text-3xl md:text-4xl font-black tracking-tight text-white mb-2 leading-none uppercase">
                  {speaker.name}
                </h3>
